...
<form class="layui-form" action="">  
   ...
   <div class="layui-form-item">
    <label class="layui-form-label">电器描述</label>
    <div class="layui-input-block">
      <input type="text" id="title" name="title" lay-verify="required" autocomplete="off" placeholder="请输入电器描述" class="layui-input" style="width:70%;">
    </div>
  </div>
...
<table class="layui-table" lay-data="{width: 1300, height:500, url:'<%=basePath%>/elec/findAll', page:true, id:'idTest'}" lay-filter="demo">
  <thead>
    <tr>
  ...
  table.on('tool(demo)', function(obj){
    ...
    //删除操作
      ...
      //layer.alert('编辑行：<br>'+ JSON.stringify(data));
	      ...
	      document.getElementById("elecNo").value=data.elecNo;
	      form.render();  
	      id = data.id;
    }
  });
